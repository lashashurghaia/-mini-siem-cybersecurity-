...
for _ in range(n_samples):
    ...
    if attack_type == 0:
        ...
        packet_count = random.randint(10, 800)
        ...
        packet_count = random.randint(1500, 12000)
        ...
        packet_count = random.randint(300, 2500)
        byte_count = packet_count * random.randint(100, 300)
        port = random.choice([22, 21, 23, 3389])
        protocol = 1

    else:
        duration = round(random.uniform(0.1, 2.0), 2)
        packet_count = random.randint(500, 4000)
